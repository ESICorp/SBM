...
namespace SBM.MailOut
{
    internal static class Function
    {
        ...
        public static string ToStringNotNull(this object data)
        {
            var isDbNull = (data as DBNull) != null;

            return (isDbNull) ? string.Empty : (string)data;
        }

        public static string[] ToArrayNotNull(this object data)
        {
            return ToStringNotNull(data).Split(new[] { ';', ',' }, StringSplitOptions.RemoveEmptyEntries);
        }
    }
}
