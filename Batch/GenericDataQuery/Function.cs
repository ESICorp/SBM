...
namespace SBM.GenericDataQuery
{
    internal static class Function
    {
        ...
        public static object ToStringOrDBNull(this string @string, int maxlength)
        {
        ...
        public static object ToDateOrDBNull(this string @string)
        {
            ...
            {
                var formats = new[] { DATE_FORMAT, DATE_FORMAT_ISO };
                return DateTime.ParseExact(@string, formats, null, DateTimeStyles.None);
            }
        }
